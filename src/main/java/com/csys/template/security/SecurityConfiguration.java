...
public class SecurityConfiguration {
    ...
    /**
     * Configure le PasswordEncoder. Pour cet exemple, il ne chiffre pas le mot de passe,
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            // Configure la gestion de session pour qu'elle soit stateless, car on utilise JWT
            ...
            // Ajoute notre filtre personnalisé de validation JWT avant le filtre standard de Spring
    ...
    /**
     * Point d'entrée pour les erreurs d'authentification, renvoie une erreur 401 Unauthorized.
     */
    ...
    /**
     * Filtre pour attraper les exceptions liées à un JWT invalide avant qu'elles n'atteignent le filtre principal.
     */
